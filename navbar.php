...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=employee_salary" class="nav-item nav-employee"><span class='icon-field'><i class="fa fa-user-tie"></i><i class="fa fa-user-tie"></i></span> Employee Salary</a>
